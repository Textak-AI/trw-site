...
function Home({nav}){return <>
  ...
  <Sec>
    ...
    <div className="r-grid-2" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:20,marginTop:16}}>
      {[
        {img:IMG.roadAhead,title:"The Road Ahead: Putting It All Together",p:"Part 4 of 4",d:"Feb 2026",url:"/insights/the-road-ahead-2"},
      ...
      ].map((a,i)=><a key={i} href={a.url} style={{textDecoration:"none",background:C.cream,borderRadius:8,overflow:"hidden",cursor:"pointer",display:"block",transition:"transform 0.15s"}}>
