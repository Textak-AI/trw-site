...
export function LegaciesContent(){return <>
  ...
  <Sec bg={C.cream}>
    ...
    <div style={{background:C.white,borderRadius:10,padding:28,borderLeft:`4px solid ${C.rust}`,marginBottom:20}}>
      ...
      <P s={{margin:0,fontStyle:"italic",color:C.black}}>Though his final run on the tracks came too soon, he has now driven his Golden Spike, leaving behind a legacy that will continue far beyond the horizon. Jesse is survived by his wife Julie, their four children — Jaden, Morgan, Ethan, and Maggie — and grandson Beckett.</P>
    </div>
  </Sec>
